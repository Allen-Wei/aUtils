...
(function () {
    ...
    aUtils.EventsBase = function () {
        ...
        this.emit = function (eventNames, current) {
            if (!eventNames || typeof (eventNames) !== "string") { return this; }
            ...
            for (var index = 0; index < names.length; index++) {
                 ...
                 * */
                    try {
                        callabck.apply(evt.current || current || this, args);
                    } catch (ex) {
                    }
                    if (evt.one) {
                        events.splice(i, 1);
        ...
        this.example = function () {
            this.on("exempleEvent", function (firstName, lastName) {
            ...
            this.one("exempleEvent", function (firstName, lastName) {
                console.log("thisOne", this);
                console.log("Hello " + firstName + " " + lastName);
            }, "greetone");

            this.emit("exampleEvent").emit("exampleEvent");
            return this;
        };
    };
    ...
    /**
     * 继承 aUtils.EventsBase
     * @param {function} fn 继承 aUtils.EventsBase
     * @returns {this} 
     */
    aUtils.EventsBase.implement = function (fn) {
        fn.prototype = new aUtils.EventsBase();
